...
class LinkedList {
    ...
    append(node) {
        ...
        // This line needs to run first so the existing tail can update it's 
        // 'next' pointer.
        this.tail.next = node
    ...
    prepend(node) {
        ...
        // This line needs to run first so the node's next pointer can
        // reference the existing head.
        node.next = this.head
